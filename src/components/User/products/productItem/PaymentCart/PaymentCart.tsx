...
// import Reiffeisen from 'src/assets/images/payment/reiffeisen.png'
// import Teb from 'src/assets/images/payment/teb.png'
const DeliveryTruck = getImage('delivery-truck.svg')
const Reiffeisen = getImage('reiffeisen.png')
const Teb = getImage('teb.png')
          ...
          <form>
            ...
            <div className="product-quantity">
              ...
              <div className="quantity-changer">
                <a className="value-changer__decrease">-</a>
                <input
                  type="text"
                  id="quantity"
                  name="quantity"
